...
export const Filter = ({ currentView, currentFilter }) => {
    ...
    useEffect(() => {
        ...
        const storedFilter = localStorage.getItem('projects_filter');
    ...
    const handleFilterChange = (newFilter) => {
        setFilter(newFilter);
        localStorage.setItem('projects_filter', newFilter);
        const params = new URLSearchParams(searchParams.toString());
            ...
            <div className="flex items-center gap-4">
                ...
                <details className="dropdown">
                    ...
                    <ul className="menu dropdown-content bg-base-100 rounded-box z-1 w-52 shadow-sm">
                        ...
                        <li><a onClick={() => handleFilterChange("new")}>New</a></li>
                        <li><a onClick={() => handleFilterChange("planning")}>Planning</a></li>
